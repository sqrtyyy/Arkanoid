...
int main()
{
    ...
    Texture t1,t2,t3,t4;
    t1.loadFromFile("images_test/background.png");
    t2.loadFromFile("images_test/comp.png");
    t3.loadFromFile("images_test/server.png");
    t4.loadFromFile("images_test/pipes.png");
    t4.setSmooth(true);
